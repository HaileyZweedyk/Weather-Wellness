...
class TestWeatherCodeTranslations(unittest.TestCase):
    ...
    def test_get_conditions(self):
        self.assertEqual(self.weatherTranslations.GetConditions(0.0), "Clear")
        self.assertEqual(self.weatherTranslations.GetConditions(1.0), "Partly Cloudy")
        self.assertEqual(self.weatherTranslations.GetConditions(2.0), "Conditions Remain Same")
        self.assertEqual(self.weatherTranslations.GetConditions(3.0), "Cloudy")
        self.assertEqual(self.weatherTranslations.GetConditions(5.0), "Haze")
        self.assertEqual(self.weatherTranslations.GetConditions(10.0), "Mist")
        self.assertEqual(self.weatherTranslations.GetConditions(11.0), "Fog")
        self.assertEqual(self.weatherTranslations.GetConditions(12.0), "Fog")
        self.assertEqual(self.weatherTranslations.GetConditions(13.0), "Lightning")
        self.assertEqual(self.weatherTranslations.GetConditions(19.0), "Funnel Cloud Formation: Take Shelter")
        self.assertEqual(self.weatherTranslations.GetConditions(20.0), "Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(21.0), "Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(22), "Snow")
        self.assertEqual(self.weatherTranslations.GetConditions(23.0), "Wintery Mix")
        self.assertEqual(self.weatherTranslations.GetConditions(24.0), "Freezing Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(25.0), "Rain Showers")
        self.assertEqual(self.weatherTranslations.GetConditions(26.0), "Snow Showers")
        self.assertEqual(self.weatherTranslations.GetConditions(27.0), "Hail")
        self.assertEqual(self.weatherTranslations.GetConditions(28.0), "Fog")
        self.assertEqual(self.weatherTranslations.GetConditions(29.0), "Thunderstorm")
        self.assertEqual(self.weatherTranslations.GetConditions(36.0), "Drifting Snow")
        self.assertEqual(self.weatherTranslations.GetConditions(38.5), "Drifting Snow")
        self.assertEqual(self.weatherTranslations.GetConditions(39.0), "Drifting Snow")
        self.assertEqual(self.weatherTranslations.GetConditions(40.0), "Fog")
        self.assertEqual(self.weatherTranslations.GetConditions(45.0), "Fog")
        self.assertEqual(self.weatherTranslations.GetConditions(49.0), "Fog")
        self.assertEqual(self.weatherTranslations.GetConditions(50.0), "Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(55.0), "Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(59.0), "Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(60.0), "Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(65.0), "Freezing Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(66.0), "Freezing Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(67.0), "Freezing Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(68.0), "Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(69.0), "Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(70.0), "Snow")
        self.assertEqual(self.weatherTranslations.GetConditions(75.0), "Snow")
        self.assertEqual(self.weatherTranslations.GetConditions(80.0), "Light Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(81.0), "Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(82.0), "Heavy Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(83.0), "Light Wintery Mix")
        self.assertEqual(self.weatherTranslations.GetConditions(84.0), "Heavy Wintery Mix")
        self.assertEqual(self.weatherTranslations.GetConditions(85.0), "Wintery Mix")
        self.assertEqual(self.weatherTranslations.GetConditions(86.0), "Heavy Snow")
        self.assertEqual(self.weatherTranslations.GetConditions(87.0), "Light Small Hail")
        self.assertEqual(self.weatherTranslations.GetConditions(88.0), "Heavy Small Hail")
        self.assertEqual(self.weatherTranslations.GetConditions(89.0), "Light Hail")
        self.assertEqual(self.weatherTranslations.GetConditions(90.0), "Heavy Hail")
        self.assertEqual(self.weatherTranslations.GetConditions(91.0), "Light Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(92.0), "Heavy Rain")
        self.assertEqual(self.weatherTranslations.GetConditions(93.0), "Light Snow")
        self.assertEqual(self.weatherTranslations.GetConditions(94.0), "Heavy Snow")
        self.assertEqual(self.weatherTranslations.GetConditions(95.0), "Thunderstorm and Hail")
        self.assertEqual(self.weatherTranslations.GetConditions(96.0), "Heavy Thunderstorm and Hail")
        self.assertEqual(self.weatherTranslations.GetConditions(97.0), "Thunderstorm")
        self.assertEqual(self.weatherTranslations.GetConditions(99.0), "Heavy Thunderstorm and Hail")
        self.assertEqual(self.weatherTranslations.GetConditions(6.0), "Not in Current Database")
        self.assertEqual(self.weatherTranslations.GetConditions(100.0), "Not in Current Database")

    def test_get_category(self):
        self.assertEqual(self.weatherTranslations.GetCategory(1, True), "Partly Cloudy")
        self.assertEqual(self.weatherTranslations.GetCategory(1, False), "Partly Cloudy Night")
        ...
        self.assertEqual(self.weatherTranslations.GetCategory(0, False), "Clear")
        self.assertEqual(self.weatherTranslations.GetCategory(20, True), "Rain")
        self.assertEqual(self.weatherTranslations.GetCategory(21, False), "Rain")
        self.assertEqual(self.weatherTranslations.GetCategory(25, False), "Rain")
        self.assertEqual(self.weatherTranslations.GetCategory(61, False), "Rain")
        self.assertEqual(self.weatherTranslations.GetCategory(65, False), "Rain")
        self.assertEqual(self.weatherTranslations.GetCategory(68, True), "Rain")
        self.assertEqual(self.weatherTranslations.GetCategory(91, True), "Rain")
        self.assertEqual(self.weatherTranslations.GetCategory(5, False), "Haze")
        self.assertEqual(self.weatherTranslations.GetCategory(11, True), "Fog")
        self.assertEqual(self.weatherTranslations.GetCategory(12, False), "Fog")
        self.assertEqual(self.weatherTranslations.GetCategory(28, False), "Fog")
        self.assertEqual(self.weatherTranslations.GetCategory(40, True), "Fog")
        self.assertEqual(self.weatherTranslations.GetCategory(45, False), "Fog")
        self.assertEqual(self.weatherTranslations.GetCategory(13, True), "Thunderstorm")
        self.assertEqual(self.weatherTranslations.GetCategory(17, False), "Thunderstorm")
        self.assertEqual(self.weatherTranslations.GetCategory(19, False), "Thunderstorm")
        self.assertEqual(self.weatherTranslations.GetCategory(29, False), "Thunderstorm")
        self.assertEqual(self.weatherTranslations.GetCategory(95, False), "Thunderstorm")
        self.assertEqual(self.weatherTranslations.GetCategory(96, False), "Thunderstorm")
        self.assertEqual(self.weatherTranslations.GetCategory(97, False), "Thunderstorm")
        self.assertEqual(self.weatherTranslations.GetCategory(99, False), "Thunderstorm")
        self.assertEqual(self.weatherTranslations.GetCategory(22, False), "Snow")
        self.assertEqual(self.weatherTranslations.GetCategory(23, False), "Snow")
        self.assertEqual(self.weatherTranslations.GetCategory(26, False), "Snow")
        self.assertEqual(self.weatherTranslations.GetCategory(70, False), "Snow")
        self.assertEqual(self.weatherTranslations.GetCategory(75, False), "Snow")
        self.assertEqual(self.weatherTranslations.GetCategory(86, False), "Snow")
        self.assertEqual(self.weatherTranslations.GetCategory(88, False), "Snow")
        self.assertEqual(self.weatherTranslations.GetCategory(93, False), "Snow")
        self.assertEqual(self.weatherTranslations.GetCategory(94, False), "Snow")
        self.assertEqual(self.weatherTranslations.GetCategory(85, False), "Wintery Mix")
