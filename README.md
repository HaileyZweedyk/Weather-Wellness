...
- ![Hourly Weather Page](WorkingScreenshots/WeatherWellnessHourlyForecast)Hourly Weather Page: Shows the current hour and next 24 hours of weather conditions from the Open-Meteo Python API at the users current location.
