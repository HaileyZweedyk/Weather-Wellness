...
class Wellness:
    ...
    def suggest_activities(self, weather_condition):
        ...
        elif weather_condition == "Cloudy" or weather_condition == "Haze" or weather_condition == "Fog":
    ...
    def driving_techniques(self, weather_condition):
        if weather_condition == "snow":
            ...
            return "- Slow down and reduce your speed."
            return "- Increase your following distance."
            return "- Drive in the tire tracks of other vehicles if possible."
            return "- Avoid sudden steering or braking to prevent loss of control."
            return "- Keep headlights on for better visibility."
        elif weather_condition == "rain":
            return "Tips for driving in the rain: "
            return "- Slow down and reduce speed to avoid slipping."
            return "- Increase your following distance to give yourself more stopping time."
            return "- Use your headlights and windshield wipers for better visibility."
            return "- Avoid driving through large puddles or flooded areas."
            return "- Turn off cruise control to maintain full control of your vehicle."
        elif weather_condition == "thunderstorm":
            return "Tips for driving in a thunderstorm: "
            return "- Use your headlights and windshield wipers to maximize visibility."
            return "- Avoid driving through flooded areas to prevent hydroplaning."
            return "- Be aware of sudden gusts of wind and potential debris on the road."
            return "-If conditions are severe pull over in a covered area to let the storm pass."
        else:
            return "Driving Conditions Safe."
...
# we need to resonsider this probs need input statments
    def mood_weather(self, weather_condition):
        ...
        elif weather_condition == "Cloudy" or weather_condition == "Haze" or weather_condition == "Foggy":
